...
const StudentTopNav = ({ uploadedImage, setActiveLink, title, text }) => {
  ...
  return (
    <div id="st-topnav" className="block container overflow-x-hidden">
      <div id="st-top">
        ...
        <nav>
          <ToggleButton
            onClick={() => setOpenNavPanel(1)}
            className={"st-btn st-upload"}
            image={null}
          >
            <i class="fa-solid fa-arrow-up-from-bracket fa-2x"></i>
          </ToggleButton>
          <ToggleButton
            onClick={() => setOpenNavPanel(2)}
            className={"st-btn st-notif"}
            image={null}
          >
