...
const TeacherGeneral = ({closePop, onImageSelection}) => {
  ...
  return (
    <div id='teach-general' className={`st-general animate__animated ${ closePop ? 'animate__zoomIn' : 'animate__zoomOut'}`} ref={popRef}>
        <div id="teach-gen-top">
            <h1>General</h1>
